...
model = SIMPLE_CON((image_size,image_size,1))
model.compile(optimizer='adam',loss="binary_crossentropy", metrics=['accuracy'])
callbacks = [tensorboard, checkpointer, ReduceLROnPlateau(monitor=('val_accuracy'), factor=0.9, patience=10, cooldown=0, min_lr=0)]
...
OUT_EXC = "RECORD/MAGVBEN_RECORD_MODEL1.xlsx"
